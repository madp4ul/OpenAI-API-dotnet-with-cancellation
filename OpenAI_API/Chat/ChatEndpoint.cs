...
namespace OpenAI_API.Chat
{
    ...
    public class ChatEndpoint : EndpointBase, IChatEndpoint
    {
        ...
        /// If you are on the latest C# supporting async enumerables, you may prefer the cleaner syntax of <see cref="StreamChatEnumerableAsync(ChatRequest,CancellationToken)"/> instead.
        /// </summary>
